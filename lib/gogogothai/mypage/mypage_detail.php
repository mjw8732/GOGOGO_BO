...
?>
                ...
                <div class="pinner">
                    ...
                    <section class="mypage_wrap clear">
                        ...
                        <h3 class="title_content mopage_title">
                            ...
                            <form action="">
                                <div class="linecontent userinfo_edit">
                                    <div class="boxinner">
                                        <ul class="btwlist">
                                            <li class="con w50 idinfo">
                                                <span>아이디</span>
                                                <p><input type="text" value="아이디넣어주세요"><button type="button" type="button"
                                                        class="btn_pop_open"
                                    ...
                                    <div class="boxinner pa24t">
                                        ...
                                        <ul class="btwlist">
                                            <li class="con w50"><a href="#" class="btn_sns kakako" target="_blank">카카오 아이디 연결하기</a></li>
                                            <li class="con w50"><a href="#" class="btn_sns naver" target="_blank">네이버 아이디 연결하기</a></li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="txtcenter">
                                        ...
                                        <button type="button" type="summit" class="btn_save btn btn_fillblue full">내용 저장하기</button>
                                    </div>
                                </div>
                            </form>
                        </div>
            ...
            <div class="layout_contain min440 heightauto">
                <div class="layout_box">
                    <div class="pop_header">
                        <h3 class="title_modal"><button type="button" class="btn_back" date-type="btn_dim_close"></button>비밀번호
                            변경</h3><button type="button" class="close btn_dim_close"></button>
                    </div>
                    <div class="pop_body scrollcustom">
                        <form action="">
                            <div class="list_box wid100">
                                ...
                                <div class="fixed_btn_wrap"><button type="button" class="btn_password_change btn btn_fillblack wid100 ma16t">변경하기</button></div>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div class="layout_popup center_modal detailpop mydetali" data-popup="phone_change">
            ...
            <div class="layout_contain min440 heightauto">
                <div class="layout_box">
                    <div class="pop_header">
                        <h3 class="title_modal"><button type="button" class="btn_back" date-type="btn_dim_close"></button>휴대폰번호
                            변경</h3><button type="button" class="close btn_dim_close"></button>
                    </div>
                    <div class="pop_body scrollcustom">
                        <form action="">
                            <div class="list_box wid100">
                                ...
                                <div class="fixed_btn_wrap"><button type="button" type="submit" class="btn_phone_change btn btn_fillblack wid100 ma16t">변경하기</button></div>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div class="layout_popup center_modal detailpop mydetali" data-popup="user_resign">
            ...
            <div class="layout_contain min440 heightauto">
                <div class="layout_box">
                    <div class="pop_header">
                        <h3 class="title_modal"><button type="button" class="btn_back" date-type="btn_dim_close"></button>회원탈퇴
                        </h3><button type="button" class="close btn_dim_close"></button>
                    </div>
                    <div class="pop_body scrollcustom">
                        <form action="">
                            ...
                            <div class="list_box wid100">
                                ...
                                <div class="fixed_btn_wrap"><button type="button" type="submit" class="btn_resign btn btn_fillblack wid100 ma16t btn_pop_open"
                                    data-popup="step2_pop">탈퇴하기</button></div>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="layout_contain min440 heightauto">
                <div class="layout_box">
                    ...
                    <div class="pop_body scrollcustom">
                            ...
                            <a href="/gogogothai/index.php" class=" btn btn_lineblack full">처음으로 돌아가기</a>
                    </div>
                </div>
            </div>
        </div>
