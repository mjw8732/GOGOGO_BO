...
?>
        ...
        <div class="layout_body">
            <div class="body_wrap">
                <div class="pinner">
                    <h2 class="title_page"><a href="/gogogothai/order/cart.php"class="btn_back mo"></a>확인 및 결제</h2>
                    <section class="cart_wrap clear">
                        <div class="cart_list_content payment_monone">
                        ...
                        <div class="right_content cartcontent">
                            ...
                            <div class="reserv_content shadow_content">
                                <div class="reserv_box">
                                    ...
                                    <div class="mo_fixed"><button class="btn_reserv btn btn_fillblue full btn_pop_open" data-popup="payreconfirm">결제하기</button></div>
                                </div>
                            </div>
                            <!-- [/] -->
                        </div>
        ...
        <div class="layout_contain min440">
          <div class="layout_box">
            <div class="pop_header">
              <h3 class="title_modal">예약완료</h3><button class="close btn_dim_close"></button>
            </div>
            <div class="pop_body scrollcustom">              
              <div class="list_box">
                ...
                <div class="mo_fixed"><a href="/gogogothai" class=" btn btn_fillblue wid100 ma24" >확인</a></div>
            </div>
            </div>
          </div>
        </div>
