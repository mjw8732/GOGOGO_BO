    ...
    var b = null,
        ...
        d = function (e, f) {
            ...
            var g = a("<li></li>").hide().html(e).appendTo(b),
                ...
                i = null;
            h.click(function () {
                clearTimeout(i), g.animate({
                    height: 0,
                    opacity: 0
                }, "fast", function () {
                    g.remove(), b.children().length || b.removeClass("active").hide()
                })
            }), c.closeForStickyOnly && !f.sticky && h.hide(), "" !== f.type && g.addClass(f.type), !b.hasClass("active") && b.addClass("active").show(), !f.sticky && f.duration > 0 && (i = setTimeout(function () {
                h.click()
            }, f.duration)), g.fadeIn("normal")
        };
    d.config = {
        width: 500,
        align: "center",
